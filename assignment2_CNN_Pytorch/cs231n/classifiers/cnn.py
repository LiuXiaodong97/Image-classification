...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores,caches['conv'] = conv_relu_pool_forward(X,self.params['W1'],self.params['b1'],conv_param,pool_param)
        scores,caches['fc1'] = affine_relu_forward(scores,self.params['W2'],self.params['b2'])
        scores,caches['fc2'] = affine_forward(scores,self.params['W3'],self.params['b3'])
        ...
        dx,grads['W3'],grads['b3'] = affine_backward(dx,caches['fc2'])
        grads['W3'] += self.reg*W3
        dx,grads['W2'],grads['b2'] = affine_relu_backward(dx,caches['fc1'])
